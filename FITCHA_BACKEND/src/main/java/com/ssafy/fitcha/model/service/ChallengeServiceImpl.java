...
public class ChallengeServiceImpl implements ChallengeService {
	...
	public ChallengeServiceImpl(ChallengeDao challengeDao,FileService fileService,ProofService proofService,CommentService commentService) {
	...
	public List<Challenge> getSearchChallenges(Search search) {
		...
		for(Challenge challenge : challengeBoardList) {
			...
			challenge.setFiles(fileService.getChallengeFileList(challengeBoardId));
		}
	...
	@Override
	public void updateChallenge(Challenge challenge, List<MultipartFile> files,List<Integer> deleteChallengeFileIds) throws Exception {
